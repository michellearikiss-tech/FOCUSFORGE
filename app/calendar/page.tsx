...
const titleStyle = {
  margin: "8px 0 0",
  fontSize: "clamp(3rem, 11vw, 4.15rem)",
  fontWeight: 400,
  lineHeight: 1,
...
const mobileLinkStyle = {
  ...
  background: "rgba(241,232,218,0.085)",
  color: "rgba(241,232,218,0.94)",
  textDecoration: "none",
  fontSize: "14px",
  fontWeight: 500,
...
const monthTitleStyle = {
  fontSize: "clamp(1.9rem, 6vw, 2.15rem)",
  fontWeight: 400,
  margin: 0,
...
const todayCellStyle = {
  boxShadow: "0 0 0 1px rgba(241,232,218,0.28)",
};
...
const focusMiniStyle = {
  borderRadius: "999px",
  padding: "4px 7px",
  background: "rgba(241,232,218,0.15)",
...
const inputStyle = {
  ...
  padding: "12px 13px",
  borderRadius: "15px",
  border: "1px solid rgba(241,232,218,0.17)",
...
const buttonStyle = {
  ...
  background: "rgba(241,232,218,0.09)",
  color: "rgba(241,232,218,0.92)",
  cursor: "pointer",
  fontSize: "15px",
  fontWeight: 600,
